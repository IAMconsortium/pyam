...
def test_set_meta_as_named_series(test_df):
    ...
    pdt.assert_series_equal(test_df["meta_values"], exp)
...
def test_set_meta_as_series(test_df):
    ...
    pdt.assert_series_equal(test_df["meta_series"], exp)
...
def test_set_meta_as_str(test_df):
    ...
    pdt.assert_series_equal(test_df["meta_str"], exp)
...
def test_set_meta_from_data(test_df):
    ...
    pdt.assert_series_equal(test_df["pe_2005"], exp)
...
def test_set_meta_from_data_max(test_df):
    ...
    pdt.assert_series_equal(test_df["pe_max_yr"], exp)
