...
def test_unfccc_tier1():
    ...
    exp = IamDataFrame(UNFCCC_DF, **INDEX_ARGS, region='DEU',
                       variable='Emissions|CH4|Agriculture', unit='kt CH4')
    ...
    types = ['Agriculture', 'Energy', 'Industrial Processes and Product Use',
