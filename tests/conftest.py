...
FULL_FEATURE_DF = pd.DataFrame([
    ['World', 'Primary Energy', 'EJ', 12, 15],
    ['reg_a', 'Primary Energy', 'EJ', 8, 9],
    ['reg_b', 'Primary Energy', 'EJ', 4, 6],
    ['World', 'Primary Energy|Coal', 'EJ', 9, 10],
    ['reg_a', 'Primary Energy|Coal', 'EJ', 6, 6],
    ['reg_b', 'Primary Energy|Coal', 'EJ', 3, 4],
    ['World', 'Primary Energy|Wind', 'EJ', 3, 5],
    ['reg_a', 'Primary Energy|Wind', 'EJ', 2, 3],
    ['reg_b', 'Primary Energy|Wind', 'EJ', 1, 2],
    ['World', 'Emissions|CO2', 'EJ', 10, 14],
    ['World', 'Emissions|CO2|Energy', 'EJ', 6, 8],
    ['World', 'Emissions|CO2|AFOLU', 'EJ', 3, 4],
    ['World', 'Emissions|CO2|Bunkers', 'EJ', 1, 2],
    ['reg_a', 'Emissions|CO2', 'EJ', 6, 8],
    ['reg_a', 'Emissions|CO2|Energy', 'EJ', 4, 5],
    ['reg_a', 'Emissions|CO2|AFOLU', 'EJ', 2, 3],
    ['reg_b', 'Emissions|CO2', 'EJ', 3, 4],
    ['reg_b', 'Emissions|CO2|Energy', 'EJ', 2, 3],
    ['reg_b', 'Emissions|CO2|AFOLU', 'EJ', 1, 1],
...
REG_DF = pd.DataFrame([
    ['IMAGE', 'a_scenario', 'NAF', 'Primary Energy', 'EJ', 1, 6],
    ['IMAGE', 'a_scenario', 'ME', 'Primary Energy', 'EJ', 2, 7],
    ['IMAGE', 'a_scenario', 'World', 'Primary Energy', 'EJ', 3, 13],
    ['MESSAGE-GLOBIOM', 'a_scenario', 'MEA', 'Primary Energy', 'EJ', 1, 6],
    ['MESSAGE-GLOBIOM', 'a_scenario', 'AFR', 'Primary Energy', 'EJ', 2, 7],
    ['MESSAGE-GLOBIOM', 'a_scenario', 'World', 'Primary Energy', 'EJ', 3, 13],
],
    columns=IAMC_IDX + [2005, 2010],
)
