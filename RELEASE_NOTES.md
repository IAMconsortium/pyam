...
- [#275](https://github.com/IAMconsortium/pyam/pull/275) Completely removes all features related to region plotting, noably `map_regions()`, `region_plot()`, and `read_shapefile()`
