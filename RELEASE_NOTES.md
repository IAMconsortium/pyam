...
- [#198](https://github.com/IAMconsortium/pyam/pull/198) Update stack plot functionality and add aggregation tutorial (also updates Makefile testing to use CI-like environment).
