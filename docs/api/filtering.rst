...
Filtering of an :class:`IamDataFrame`
-------------------------------------
...
Index
^^^^^
- A *column* of the :attr:`IamDataFrame.index <pyam.IamDataFrame.index>`
...
with appropriate columns or index dimensions (i.e., :code:`['model', 'scenario']`) using
